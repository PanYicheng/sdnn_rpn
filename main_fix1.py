...
def main():
    ...
    # Results directories
    path_set_weigths = 'results_fix1/'
    path_save_weigths = 'results_fix1/'
    path_features = 'results_fix1/'
    ...
    network_params = [{'Type': 'input', 'num_filters': 1, 'pad': (3, 3), 'H_layer': DoG_params['img_size'][1],
                       'W_layer': DoG_params['img_size'][0]},
                      {'Type': 'conv', 'num_filters': 4, 'filter_size': 5, 'th': 10.},
                      {'Type': 'pool', 'num_filters': 4, 'filter_size': 2, 'th': 0., 'stride': 2},
                      {'Type': 'conv', 'num_filters': 200, 'filter_size': 5, 'th': 10.},
                      {'Type': 'pool', 'num_filters': 200, 'filter_size': 2, 'th': 0., 'stride': 2},
                      {'Type': 'conv', 'num_filters': 400, 'filter_size': 5, 'th': 10.},
    ...
    stdp_params = {'max_learn_iter': max_learn_iter,
                   ...
                   'a_minus': np.array([0, .003, 0, .0003, 0, .0003, 0, .0003, 0], dtype=np.float32),
                   'a_plus': np.array([0, .004, 0, .0004, 0, .0004, 0, .0004, 0], dtype=np.float32),
