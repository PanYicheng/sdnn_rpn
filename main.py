...
def main():
    ...
    max_learn_iter = [0, 6000, 0, 8000, 0, 10000, 0, 12000, 0, 14000]
    stdp_params = {'max_learn_iter': max_learn_iter,
                   'stdp_per_layer': [0, 10, 0, 8, 0, 5, 0, 5, 0, 5],
                   'max_iter': sum(max_learn_iter),
                   'a_minus': np.array([0, .003, 0, .0003, 0, .0003, 0, .0003, 0, .0003], dtype=np.float32),
                   'a_plus': np.array([0, .004, 0, .0004, 0, .0004, 0, .0004, 0, .0004], dtype=np.float32),
                   'offset_STDP': [0, floor(network_params[1]['filter_size']),
                                   ...
                                   0,
                                   floor(network_params[9]['filter_size']),
                                   ]}
